...
public class BlueJeansGroupsAdapter extends BaseGroupsAdapter<BlueJeansUser, BlueJeansGroup> {


    @Override
    protected BlueJeansGroup constructGroup(Set<Attribute> attributes, boolean creation) {
        return new BlueJeansGroup();

    }

    @Override
    protected ConnectorObject constructConnectorObject(BlueJeansGroup group) {
